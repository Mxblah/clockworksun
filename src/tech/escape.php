        ...
        <main id="mainContent" class="site-content">
            ...
            <section class="w3-container w3-content w3-row-padding w3-padding-64">
                <div class="w3-twothird">
                    <h5 class="cs-padding-top-32 w3-margin-right">There are <h3 class="tx-hammer"><?php
                        $time = "Sat, 19 Dec 2020 10:30:00 -0500 (EST)";
                        echo time_elapsed_string($time, true);
                    ?></h3> left before I graduate from Michigan Tech and can escape Houghton, MI.</h5>
                </div>

                <div class="w3-third w3-center">
                    <a href="#"><img src="https://clockworksun.com/media/clockworksun-512.png" alt="Clockwork Sun" class="w3-round-xlarge w3-image w3-card-4 cs-hover-opacity-light"></a>
                </div>
            </section>
